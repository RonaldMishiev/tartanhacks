...
class AssemblyView(Static):
    ...
    def set_asm(self, highlighted) -> None:
        """
        Update the assembly pane with a Rich renderable (from Member D's
        highlight_asm, or a plain Rich Text fallback).

        Args:
            highlighted: A Rich Syntax or Text renderable.
        """
